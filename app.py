    ...
    def process(self):
        ...
        try:
            if len(def_paths) > 0:
                ...
                dlg.setText(
                    "Your document is under processing. It might take few minutes. Please DO NOT exit...")
                dlg.exec()
                scopes = {
                    'https://www.googleapis.com/auth/spreadsheets',
                    'https://www.googleapis.com/auth/drive'
                }
                secret_key_path = os.getcwd() + '/secret_key.json'
